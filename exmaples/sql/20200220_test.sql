...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "FNSH_RESULT"."COLUMN1" IS '임시';
   COMMENT ON COLUMN "FNSH_RESULT"."COLUMN2" IS '임시';
...
--------------------------------------------------------
 ...
 LOB ("SOLUTION") STORE AS BASICFILE (
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
   ...
   COMMENT ON COLUMN "FNSH_TEST"."COLUMN1" IS '임시';
   COMMENT ON COLUMN "FNSH_TEST"."COLUMN2" IS '임시';
--------------------------------------------------------
...
--------------------------------------------------------
 ...
 LOB ("CONTENT") STORE AS BASICFILE (
  ...
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)) ;
   ...
   COMMENT ON COLUMN "UNIT"."COLUMN1" IS '임시';
   COMMENT ON COLUMN "UNIT"."COLUMN2" IS '임시';
   COMMENT ON COLUMN "UNIT"."COLUMN3" IS '임시';
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  TABLESPACE "USERS" ;
   ...
   COMMENT ON COLUMN "UNIT_COMPLETION"."COLUMN1" IS '임시';
   COMMENT ON COLUMN "UNIT_COMPLETION"."COLUMN2" IS '임시';
   COMMENT ON COLUMN "UNIT_COMPLETION"."COLUMN3" IS '임시';
REM INSERTING into TEST.APP_USER
SET DEFINE OFF;
REM INSERTING into TEST.CHALLENGE
SET DEFINE OFF;
REM INSERTING into TEST.CHALLENGE_CASE
SET DEFINE OFF;
REM INSERTING into TEST.CHALLENGE_RESULT
SET DEFINE OFF;
REM INSERTING into TEST.FNSH_RESULT
SET DEFINE OFF;
REM INSERTING into TEST.FNSH_TEST
SET DEFINE OFF;
REM INSERTING into TEST.SUBJECT
SET DEFINE OFF;
REM INSERTING into TEST.UNIT
SET DEFINE OFF;
REM INSERTING into TEST.UNIT_COMPLETION
SET DEFINE OFF;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "CHALLENGE_RESULT_PK" ON "CHALLENGE_RESULT" ("C_NUM") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS" ;
...
--------------------------------------------------------
  ...
  ALTER TABLE "CHALLENGE_RESULT" ADD CONSTRAINT "CHALLENGE_RESULT_PK" PRIMARY KEY ("C_NUM")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1 BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
  TABLESPACE "USERS"  ENABLE;
...
--------------------------------------------------------
  ...
  ALTER TABLE "FNSH_TEST" ADD CONSTRAINT "FNSH_TEST_FK2" FOREIGN KEY ("TEST_NUM")
	  REFERENCES "APP_USER" ("USER_NUM") ENABLE;
--------------------------------------------------------
